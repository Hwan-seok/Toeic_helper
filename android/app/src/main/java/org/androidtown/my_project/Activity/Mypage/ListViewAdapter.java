...
import org.androidtown.my_project.Activity.DailyAnswerActivity;
import org.androidtown.my_project.Activity.LoginActivity;
import org.androidtown.my_project.Activity.MenuActivity;
...
public class ListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView ProblemTextView = (TextView) convertView.findViewById(R.id.problem) ;
    ...
    public void addItem( int number, String problem, String op1, String op2, String op3, String op4, String answer) {
        ListViewItem item = new ListViewItem();

        item.setNumber(number);
        item.setProblemStr(problem);
        item.setOption1(op1);
        item.setOption2(op2);
        item.setOption3(op3);
        item.setOption4(op4);
